...
final class ConfrontationAction
{
    private $view;
    private $logger;
    ...
    public function dispatch(Request $request, Response $response, $args)
    {
        ...
        $key = FileSystemCache::generateCacheKey('cache-feed_ConfrontationAction', null);
    ...
    public function processInfo($html)
    {
        ...
        return array(
            'title' => (string) S::create('Libertadores')->toUpperCase(),
            'step' => (string) S::create($doc['#widget-classificacao .tabela-navegacao .tabela-navegacao-seletor-ativo']->text())->toUpperCase(),
    ...
    public function processMatches($html)
    {
            ...
            'matches' => array(
                array(
                    ...
                    'teams' => array(
                        ...
                        'score' => array(
                            'active' => true,
                            'home' => $doc['div.placar-jogo:eq(0) .placar-jogo-equipes .placar-jogo-equipes-placar .placar-jogo-equipes-placar-mandante']->text(),
                            'visitor' => $doc['div.placar-jogo:eq(0) .placar-jogo-equipes .placar-jogo-equipes-placar .placar-jogo-equipes-placar-visitante']->text()
                        )
                    )
                ),
                array(
                    ...
                    'teams' => array(
                        ...
                        'score' => array(
                            'active' => true,
                            'home' => $doc['div.placar-jogo:eq(1) .placar-jogo-equipes .placar-jogo-equipes-placar .placar-jogo-equipes-placar-mandante']->text(),
                            'visitor' => $doc['div.placar-jogo:eq(1) .placar-jogo-equipes .placar-jogo-equipes-placar .placar-jogo-equipes-placar-visitante']->text()
                        )
                    )
                )
            )
        ...
        if(strlen($data['matches'][0]['teams']['score']['home']) == 0 && strlen($data['matches'][0]['teams']['score']['visitor']) == 0)
        {
            ...
            $data['matches'][0]['teams']['score']['home'] = '0';
            $data['matches'][0]['teams']['score']['visitor'] = '0';
        }

        if(strlen($data['matches'][1]['teams']['score']['home']) == 0 && strlen($data['matches'][1]['teams']['score']['visitor']) == 0)
        {
            $data['matches'][1]['teams']['score'] = false;
            $data['matches'][1]['teams']['score']['home'] = '0';
            $data['matches'][1]['teams']['score']['visitor'] = '0';
        }
